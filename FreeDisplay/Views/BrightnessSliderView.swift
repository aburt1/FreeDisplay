...
struct BrightnessSliderView: View {
    ...
    var body: some View {
        VStack(spacing: 2) {
            ...
            .padding(.top, 2)
            .accessibilityLabel(display.isBuiltin ? "Brightness control mode: System" : "Brightness control mode: \(ddcStatus == true ? "DDC hardware" : "Software simulated")")
            .help(display.isBuiltin ? "System brightness: controls the built-in display via the system API" : "DDC: hardware brightness control\nSoftware: brightness adjusted in software")
